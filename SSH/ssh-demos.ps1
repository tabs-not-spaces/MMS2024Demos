...
$sb = {
    New-Item -Path "C:\stepHen.txt" -ItemType File -Force
    Add-Content -Path "C:\stepHen.txt" -Value $using:stepHen
}
Invoke-Command -Session $session -scriptBlock $sb
invoke-command -Session $session -ScriptBlock {get-content -raw C:\stepHen.txt}
#endregion
#endregion
#endregion
